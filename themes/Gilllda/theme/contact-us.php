...
get_header(); ?>
    ...
    <section
            class="container max-lg:px-3 max-w-content z-[1] max-lg:pb-3 relative flex justify-start flex-wrap items-center">
        ...
        <div class="bg-gray-800 w-full mb-5 sticky <?= $textColor; ?> <?= current_user_can('administrator') ? 'top-24' : 'top-20'; ?> lg:-ms-4 px-5 py-16 lg:py-20 lg:px-12 rounded-md lg:basis-4/12 flex flex-col gap-y-8 lg:items-start items-center">
            ...
            <?php endif;
            ?>
            <nav aria-label="social network links" class="flex items-center justify-center">
