<svg class="bi bi-stopwatch-fill shrink-0 <?= $args['class'] ?? ''; ?>" width="<?= $args['size'] ?? '20' ?>" height="<?= $args['size'] ?? '20' ?>"
     fill="currentColor"
     viewBox="0 0 16 16">
    <path
...
//    'class' => ''
//);
//get_template_part('template-parts/svg/stopwatch-fill', null, $args);
?>