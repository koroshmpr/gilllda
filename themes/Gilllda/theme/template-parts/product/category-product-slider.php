...
// 2. Define Query Logic
        ...
        <section class="rtl container max-lg:px-3 my-5" dir="rtl">
            ...
            <div class="flex-1 flex flex-col overflow-hidden w-full bg-primary border border-black/10 rounded-lg p-4 lg:px-8">
                <div class="flex-1 w-full group/amazing !overflow-visible <?= $count > 3 ? 'lg:px-6' : '' ?> relative swiper post-slider [&>.swiper-button-disabled]:hidden"
