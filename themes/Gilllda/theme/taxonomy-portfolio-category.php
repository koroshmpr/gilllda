...
<!--		<h1 class="text-white text-3xl lg:text-8xl">--><?php //= esc_html(single_term_title('', false)); ?><!--</h1>-->
<!--	</header>-->
...
<!--					<img class="w-full object-cover aspect-square" height="250" src="--><?php //= the_post_thumbnail_url(); ?><!--"-->
<!--						 alt="image of the --><?php //= get_the_title(); ?><!-- post">-->
<!--					<div-->
...
<!--						<p class="text-base lg:text-2xl text-center">--><?php //= get_the_title(); ?><!--</p>-->
<!--					</div>-->
<!--				</a>-->
<!--			--><?php
//			endwhile;
