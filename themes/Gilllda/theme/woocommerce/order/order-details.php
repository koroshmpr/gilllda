...
?>
    <section class="woocommerce-order-details flex-1 ">
        <?php do_action( 'woocommerce_order_details_before_order_table', $order ); ?>

        <div class="my-3 border-b border-black/15">
            <h2 class="woocommerce-order-details__title border-b w-fit border-primary pb-2"><?php esc_html_e( 'Order details', 'woocommerce' ); ?></h2>
        </div>
